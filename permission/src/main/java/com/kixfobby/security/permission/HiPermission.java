package com.kixfobby.security.permission;
...
//    private static HiPermission mInstance;
    ...
    private String[] mNormalPermissions = {
            WRITE_EXTERNAL_STORAGE, ACCESS_FINE_LOCATION, CAMERA, SEND_SMS, READ_PHONE_STATE, READ_CONTACTS, RECORD_AUDIO};
    private int[] mNormalPermissionIconRes = {
            R.drawable.permission_ic_storage, R.drawable.permission_ic_location, R.drawable.permission_ic_camera, R.drawable.permission_ic_sms, R.drawable.permission_ic_phone, R.drawable.permission_ic_contacts, R.drawable.permission_ic_micro_phone,};
