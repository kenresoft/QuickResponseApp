...
public class PermissionActivity extends AppCompatActivity {
    ...
    private void showPermissionDialog() {
        ...
        contentView.setGridViewColum(Math.min(mCheckPermissions.size(), 3));
    ...
    private void reRequestPermission(final String permission) {
        ...
        if (getPermissionItem(permission) != null) {
            permissionName = getPermissionItem(permission).PermissionName;
        }
